...
public class DataManager
{
    ...
    public DataManager()
    {
        ...
        var string_conexion = "workstation id=ProyectoPav.mssql.somee.com;packet size=4096;user id=lautaF_SQLLogin_1;pwd=3qqdydoszt;data source=ProyectoPav.mssql.somee.com;persist security info=False;initial catalog=ProyectoPav";
